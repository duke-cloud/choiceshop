...
/*
        $insertQuery="INSERT INTO users (full_name,email,password,permissions)
         VALUES ('$name','$email','$hashed','$permissions')";

**/
$insertQuery="INSERT INTO users ( `full_name`, `email`, `password`, `join_date`, `last_login`, `permissions`) VALUES
 ( '$name', '$email', '$hashed', '2018-07-10 00:00:00', '2018-07-18 00:00:00', '$permissions')";

         if(isset($_GET['edit'])){
           $insertSql = "UPDATE users SET `full_name` ='$name', `email`='$email',
 ...
 <form action="users.php?<?=((isset($_GET['edit']))?'edit='.$user_id:'add=1');?>" method="POST">
