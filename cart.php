...
if($cart_id != ''){
$cartQ = $db->query("SELECT * FROM cart WHERE id = '$cart_id'");//echo $cartQ;
        ...
        <form action ="thankyou.php" method="post" id ="payment-form">
          ...
          <input type="hidden" name ="grand_total" value="<?=$grand_total;?>">
            <input type="hidden" name ="cart_id" value="<?= $cart_id;?>">
              <input type="hidden" name ="description" value="<?= $item_count.'item'.(($item_count>1)?'s':'').'from choiceshop';?>">
...
function check_address(){
  ...
  jQuery.ajax({
   url :'/choiceshop/admin/parsers/check_address.php',
   method : 'POST',
   data : data,
